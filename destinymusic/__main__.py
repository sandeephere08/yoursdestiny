...
from destinymusic.core.call import Hotty
...
async def init():
    ...
    LOGGER("destinymusic.plugins").info("Successfully Imported Modules...")
    await userbot.start()
    await Hotty.start()
    try:
    ...
    await app.stop()
    await userbot.stop()
    LOGGER("destinymusic").info("Stopping Brandrd Music Bot...")
