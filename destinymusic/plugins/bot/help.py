...
from destinymusic.utils import help_pannel
...
from destinymusic.utils.inline.help import help_back_markup, private_help_panel
from config import BANNED_USERS, START_IMG_URL, SUPPORT_CHAT
from strings import get_string, helpers
from destinymusic.utils.stuffs.buttons import BUTTONS
from destinymusic.utils.stuffs.helper import Helper
...
@languageCB
async def mb_plugin_button(client, CallbackQuery, _):
    callback_data = CallbackQuery.data.strip()
    cb = callback_data.split(None, 1)[1]
