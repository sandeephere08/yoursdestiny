    ...
    await message.reply_video(
        ...
        reply_markup=InlineKeyboardMarkup(
            ...
            InlineKeyboardButton(
                text="☆ 𐏓 𝅥‌꯭𝆬ᷟ𝐣‌‌‌➥‌𝗭𝗲‌𝗳𝗿𝗼‌𝗻 ‌🔥❰⎯꯭ ꭗ‌‌ 🍂 💗 ", url=f"https://t.me/crush_hu_tera"
            ),
            InlineKeyboardButton(
                text="☆ ꜱᴜᴘᴘᴏʀᴛ 💗", url=f"https://t.me/+AzKGhJreNmhiZTll"
            ),
        ],
                [
            InlineKeyboardButton(
                text="☆ ᴄʜᴀɴɴᴇʟ💗", url=f"https://t.me/chamber_of_heart1"
            ),
                ],
                [
                    InlineKeyboardButton(
