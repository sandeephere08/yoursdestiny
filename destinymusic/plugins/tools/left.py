...
bg_path = "destinymusic/assets/userinfo.png"
font_path = "destinymusic/assets/hiroko.ttf"
...
async def left_command(client: Client, message: Message):
    """Handle the /left command"""
    await message.reply_text("This command is used to handle member left events.")
