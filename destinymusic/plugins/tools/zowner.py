...
from destinymusic.mongo.afkdb import LOGGERS as OWNERS
from destinymusic.utils.database import add_served_chat, get_assistant
            ...
            [
                [
                    InlineKeyboardButton(
                        "ƨσʋяcɛ", url=f"https://github.com/WCGKING/destinymusic"
                    )
                ]
            ]
        ),
