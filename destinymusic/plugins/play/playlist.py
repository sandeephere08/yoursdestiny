...
from destinymusic import Carbon, app, YouTube
from destinymusic.utils import YouTube_videos
from destinymusic.utils.database import get_lang, is_music_playing, music_on
from destinymusic.utils.decorators.language import language, languageCB, LanguageStart
from destinymusic.utils.inline import close_markup, stream_markup, stream_markup2
from destinymusic.utils.stream.autoclear import auto_clean
from destinymusic.utils.thumbnails import get_thumb
from destinymusic.utils.pastebin import HottyBin
...
async def add_playlist(client, message: Message, _):
    ...
    if "https://youtu.be" in query:
        ...
        from destinymusic import YouTube
